...
export interface BookingContext {
  ...
  // yalnız ACTIVE satırlar — resolveEffective/normalizeEtutBookings sözleşmesi (CANCELLED asla gelmez)
  otherBookings: NormalizedBooking[];                 // öğrencinin o haftaki DİĞER etüt kayıtları (bu sablon hariç)
